...
namespace lab_work_0207
{
    ...
    internal class Program
    {
        ...
        static void Сonditions()
        {
            Delegate @delegate = null;

            Console.WriteLine("Введите количество фаз: ");
            int n = int.Parse(Console.ReadLine());
            int[] trajectory = new int[n];

            Console.WriteLine("\nВведите последовательность траектории: ");
            Console.WriteLine(
                    "1 - Array Vector\n" +
                    "2 - Vectors\n" +
                    "3 - LinkedListVector\n" +
            ...
            for (int i = 0; i < n; i++) 
                trajectory[i] = int.Parse(Console.ReadLine());

            for (int i = 0; i < n; i++)
            {
                Console.WriteLine("Фаза {0}", i+1);
